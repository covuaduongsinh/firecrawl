...
import { exportToZip, exportToMergedMarkdown, exportToBatchJson, triggerBlobDownload } from '@/lib/batchExporter';
...
export default function BatchDocExtractor({
  ...
  const handleExportZip = async () => {
    ...
    try {
      await exportToZip(categories, 'Frappe-Education');
    } catch (err: any) {
  ...
  const handleExportMergedMd = () => {
    exportToMergedMarkdown(categories, 'Frappe-Education');
  };

  const handleExportBatchJson = () => {
    exportToBatchJson(categories, 'Frappe-Education');
  };
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-slate-900 border-slate-800 shadow-xl">
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Tự động quét toàn bộ cây thư mục, cào nội dung & dịch thuật hàng loạt
                </p>
              </div>
            </div>
        ...
        <CardContent className="pt-4 space-y-4">
          ...
          {/* AI Settings & Prompt Bank (Accordion or Compact Bar) */}
